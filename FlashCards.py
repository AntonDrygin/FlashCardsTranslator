...
with open('D:\CATALOG\EDUCATION\PROGRAMMING\PHYTON\Scripts\Vocabulary\Vocabulary.txt', 'r', encoding='utf-8') as file:
...
output_directory = 'D:\CATALOG\My Computer\My downloads\FlashCardsResalt'
os.makedirs(output_directory, exist_ok=True)

timestamp = int(time.time())  # Текущее время в секундах с начала эпохи
